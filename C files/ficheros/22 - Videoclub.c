...
Nótese que esto puede hacerse por la naturaleza peculiar de los datos del fichero. En otros programas, esta asignación consecutiva de códigos quizá no pueda hacerse. Cada caso debe ser estudiado por separado.

Como siempre, se recomienda revisar atentamente el código del programa (a ser posible, después de haber intentado hacerlo).
