...
void binaria(void)
{
	...
	//a este punto el vector ya se encuentra ordenado
	...
	while(inf <= sup)
	{
		...
		if(vector[mitad] > dato)
		{
			//ahora el valor superior toma el valor de mitad
			sup = mitad;
			//mitad cambia de valor para iniciar a buscar de nuevo desde ahi
			mitad=(inf + sup)/2;
		}
