...
typedef struct 
{
	...
	int edad;
	long int codigo;
	char materia1[30],materia2[30],materia3[30];
...
int main(void)
{
	...
	do
	{
		...
		case 3:
		{
			...
			printf("los valores han sifo agregados en el orden correspondiente\n");
			break;
		}
		case 4:
		{
