...
float datos(float*base, float*altura,float *area,int cant);
float liberar(float*base, float*altura,float *area);
...
float area(float*base, float*altura)
{
	...
	if(base == NULL ||altura == NULL)  //revisar si se pudo abrir
	{
