...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("bichosiu.xcf").convert()
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.image.load("balon de oro.xcf").convert()
        self.image.set_colorkey(BLACK)
        self.rect = self.image.get_rect()
        self.rect.y = y
        self.rect.centerx = x
...
def show_go_screen():
    ...
    draw_text(screen,"instrucciones", 27, WIDTH //2, HEIGHT //2.5)
    draw_text(screen,"Ayuda al bicho a salvar a la humanidad de la tirania de messifer destruyendolo", 30, WIDTH //2, HEIGHT //2)
...
meteor_images = []
meteor_list = ["messi.xcf","messi2.xcf","messi3.xcf","messi4.xcf",
                "messi5.xcf","messi6.xcf","messi7.xcf","messi8.xcf",
                "messi9.xcf","messi10.xcf"]
...
#imagen de fondo
background = pygame.image.load("tierra.jpg").convert()
background2 = pygame.image.load("cristiano ronaldo.jpg").convert()
#cargar sonidos
laser_sound = pygame.mixer.Sound("siuuu.ogg")
